...
The accuracey of the model for different b-tagged jet multiplicities, compared to this naive approach, is shown in Table \ref{tab:topMatchAcc2lSS}.
...
%    \centering
 ...
 %   \caption{Data/MC comparisons of input features for top3l training for 79.8 $fb^{-1}$ of data. (a) show the DL1r WP of jet 0, (b) the $p_T$ of jet 0, (c) $\Delta R$ between jet 0 and jet 1, (d) the invariant mass of lepton 1 and jet 1, (e) $\Delta R$ between lepton 0 and jet 0, and (f) $\Delta R$ between lepton 0 and jet 1}
