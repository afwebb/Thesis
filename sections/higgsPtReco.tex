...
The correct lepton is identified 80\% of the time.
...
\include{sections/tables/tabNames_pt2lSS.tex}
...
\begin{figure}[h!]
    ...
    \subfigure[]{\includegraphics[width=.48\linewidth]{ptReco/higgsTop2lSS/keras_test_norm2Dhist.png}}\\
    \caption{}
    \label{fig:pt2lSSresults}
\end{figure}

As the analysis strategy targets a two $p_T$ bin fit, the problem ultimately reduces to a binary classification problem.
...
\include{sections/tables/tabNames_pt3lS.tex}
...
\begin{figure}[h!]
    ...
    \subfigure[]{\includegraphics[width=.48\linewidth]{ptReco/higgsTop3lS/keras_test_norm2Dhist.png}}\\                     
    \caption{}
...
\include{sections/tables/tabNames_pt3lF.tex}
...
\begin{figure}[h!]
    ...
    \subfigure[]{\includegraphics[width=.48\linewidth]{ptReco/higgsTop3lF/keras_test_norm2Dhist.png}}\\                     
    \caption{}
...
\include{sections/tables/tabNames_decay3l.tex}
