...
Output distributions of each MVA are shown in figure \ref{fig:sigBkgScore}. 

\begin{figure}
  \subfigure[]{\includegraphics[width=.3\linewidth]{trexPlots/stat2l_80/Plots/sigBkg_2lSS_highPt.png}}%
  \subfigure[]{\includegraphics[width=.3\linewidth]{trexPlots/stat3l_80/Plots/sigBkg_3lS_highPt.png}}%
  \subfigure[]{\includegraphics[width=.3\linewidth]{trexPlots/stat3l_80/Plots/sigBkg_3lF_highPt.png}}\\
  \subfigure[]{\includegraphics[width=.3\linewidth]{trexPlots/stat2l_80/Plots/sigBkg_2lSS_lowPt.png}}%
  \subfigure[]{\includegraphics[width=.3\linewidth]{trexPlots/stat3l_80/Plots/sigBkg_3lS_lowPt.png}}%
  \subfigure[]{\includegraphics[width=.3\linewidth]{trexPlots/stat3l_80/Plots/sigBkg_3lF_lowPt.png}}
