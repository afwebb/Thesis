...
All leptons are required to pass a non-prompt BDT selection developed by the main $t\bar{t}H-ML$/$t\bar{t}W$ analysis, described in detail in \cite{ttH_paper}. Optimized working points and scale factors for this BDT are taken from that analysis. This BDT and the WPs used are summarized in Appendix \ref{sec:lepMVA},
