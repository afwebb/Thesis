...
\begin{figure}[H]
    ...
    \caption{Data/MC comparisons in the $2lSS$ preselection region for (a) lepton \pt 0, (b) lepton \pt 1, (c) invariant mass of the two leptons, (d) the jet multiplicity, (e) the b-jet multiplicity, and (f) the missing transverse energy.}                           
...
\begin{figure}[H]
    ...
    \caption{Data/MC comparisons in the $3l$ preselection region for (a) lepton \pt 0, (b) lepton \pt 1, (c) invariant mass of the two leptons, (d) the jet multiplicity, (e) the b-jet multiplicity, and (f) the missing transverse energy.}
    \label{fig:presel3l}                                                                                          
\end{figure}
